...
mysql -u root -p -e "CREATE DATABASE TelemetryDB;
                    CREATE USER TelemetryDBUser@localhost IDENTIFIED BY '123';
                    GRANT ALL PRIVILEGES ON TelemetryDB.* TO TelemetryDBUser@localhost;
                    FLUSH PRIVILEGES;
